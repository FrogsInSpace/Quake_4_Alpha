effect effects/explosions/surface/huge_explosion
{
	size	16521
	...
	spawner "smoke5"
	{
		...
		sprite
		{
			...
			{
				size { line 6000,6000,10000,10000 }
				fade { point 1 }
	...
	spawner "fire up2"
	{
		...
		sprite
		{
			...
			{
				size { line 8000,4000,11000,4000 }
				fade { point 1 }
				rotate { box -0.222222,0.222222 }
			}
		}
	...
	spawner "fire2"
	{
		...
		sprite
		{
			...
			{
				size { line 7000,7000,12000,10000 }
				fade { point 1 }
	...
	spawner "smoke6"
	{
		...
		sprite
		{
			...
			{
				size { line 2000,2000,14000,8000 }
				fade { point 1 }
				rotate { box -0.222222,0.222222 }
			}
		}
	...
	spawner "fire up3"
	{
		...
		sprite
		{
			...
			{
				size { line 8000,6000,12000,10000 }
				fade { point 1 }
				rotate { box -0.222222,0.222222 }
			}
		}
	...
	spawner "fire up4"
	{
		...
		sprite
		{
			...
			{
				size { line 6000,4000,10000,6000 }
				fade { point 1 }
				rotate { box -0.222222,0.222222 }
			}
		}
