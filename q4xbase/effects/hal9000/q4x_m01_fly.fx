effect effects/hal9000/q4x_m01_fly
{
	size	612
	...
	emitter "trail"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { line 0,0,0.501961,0,0.25098,0.501961 }
				fade { point 0.4 }
				offset { point -5,0,0 }
				rotate { box 0,1 }
			}
	...
	emitter "sparks_lines"
	{
		...
		line
		{
			...
			start
			{
				...
				size { box 0.5,1 }
				tint { line 0,1,1,0,0.25098,0.501961 }
	...
	emitter "unnamed10"
	{
		...
		{
			duration	1,1
			material	"gfx/effects/hal9000/rocket_trail_blue"
