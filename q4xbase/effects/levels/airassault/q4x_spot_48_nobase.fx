effect effects/levels/airassault/q4x_spot_48_nobase
{
	size	179
	...
	emitter "smoke"
	{
		...
		sprite
		{
			...
			start
			{
				position { cylinder 0,-10,-19,30,10,1 }
	...
	emitter "fire5"
	{
		...
		sprite
		{
			...
			start
			{
				position { cylinder 0,-10,-19,0,10,1 }
	...
	emitter "fire4"
	{
		...
		sprite
		{
			...
			start
			{
				position { cylinder -5,-5,-19,5,5,-19 }
