effect effects/monsters/flyer_space/q4x_explode
{
	size	5797
	...
	emitter "nose"
	{
		...
		model
		{
			...
			start
			{
				velocity { box -50,-1800,-50,50,-1600,50 }
			}
	...
	emitter "wingleft"
	{
		...
		model
		{
			...
			start
			{
				velocity { box -50,-1000,800,50,-800,1000 }
			}
	...
	emitter "tail"
	{
		...
		model
		{
			...
			start
			{
				velocity { box -50,-1000,-100,50,-800,100 }
	...
	emitter "tailleft"
	{
		...
		model
		{
			...
			start
			{
				velocity { box -250,-1000,800,250,-800,1000 }
				rotate { point 0.25,0.25,0.25 }
			}
	...
	emitter "tailright"
	{
		...
		model
		{
			...
			start
			{
				velocity { box -250,-1000,-1000,250,-800,-800 }
				rotate { point 0.25,0.25,0.25 }
			}
