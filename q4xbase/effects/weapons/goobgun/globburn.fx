effect effects/weapons/goobgun/globburn
{
	size	509
	...
	emitter "Flames2"
	{
		...
		sprite
		{
			...
			blend	add
			persist
			material	"gfx/effects/q4x/fire/fire01"
			gravity		-0.15,-0.05
	...
	spawner "glob"
	{
		...
		{
			duration	6,6
			material	"models/weapons/goob_gun/flame_glob"
			model		"models/weapons/goob_gun/flame_gun_globsmall.ase"
		}
	}
	light "light"
	{
