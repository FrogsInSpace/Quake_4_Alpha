...
The retail implementation delegates to the separately owned rvInput XInput
backend. That backend is intentionally absent while auxiliary/tool input is
disabled, so expose the exact win_input.obj API as an inert device.
====================
*/
