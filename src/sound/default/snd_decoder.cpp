...
// The bundled Ogg/Vorbis C objects are configured to route their allocations
// through these engine-owned entry points.  Decoding itself remains disabled
// until the recovered streaming state has been validated, but the allocation
// ABI must still be present in the executable.
extern "C" {
