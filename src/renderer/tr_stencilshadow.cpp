...
static void R_ProjectPointsToFarPlane( const idRenderEntityLocal *ent, const idRenderLightLocal *light,
	...
	renderSystem->LightProjectionMatrix( lv, lightPlaneLocal, mat );
...
static void R_CreateShadowVolumeInFrustum( const idRenderEntityLocal *ent, 
	...
	// The retail runtime routes the expensive offline optimizer through
	// rvToolsStub.  With the tools build disabled that stub returns false,
	// so all shadow volumes intentionally use this real-time path.
