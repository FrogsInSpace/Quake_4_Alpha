...
//==========================================================
	...
	int					cubeFaceBound;			// last cube-map face bound by the backend
...
public:
	...
	rvTexRenderTarget *mRenderTarget = NULL;
};
...
public:
	...
	idImage *			reflectionImage;			// water reflection subviews
...
extern ID_TIME_T ProgramImagesTimestamp;
extern bool gWriteProgramFlag;
