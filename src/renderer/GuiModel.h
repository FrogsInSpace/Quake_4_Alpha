...
public:
	...
	void	EmitToCurrentView( float modelMatrix[16], int depthHackInViewID, float *shaderParms );
	void	EmitFullScreen();
...
private:
	void	AdvanceSurf();
	void	EmitSurface( guiModelSurface_t *surf, float modelMatrix[16], float modelViewMatrix[16], int depthHackInViewID, float *shaderParms );
