...
// These public render-world entry points are owned by tr_rendertools.obj in
// the retail PDB.  They deliberately forward to the backend debug queues.
void idRenderWorldLocal::ShowDebugLines() {
	RB_ShowDebugLines();
}

void idRenderWorldLocal::ShowDebugPolygons() {
	RB_ShowDebugPolygons();
}

void idRenderWorldLocal::ShowDebugText() {
	RB_ShowDebugText();
}
