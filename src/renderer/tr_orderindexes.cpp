...
#if 0
// The Doom 3 seed implementation is retained only as provenance.  The Quake 4
// retail PDB contains tr_orderIndexes.obj but records no functions or data for
// it, and the sole call site in tr_trisurf.cpp is compiled out.
