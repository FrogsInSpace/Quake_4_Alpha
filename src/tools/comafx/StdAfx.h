...
// Match the Win32 API level used by the original Quake 4 tools.  This must
// precede MFC so the current Windows SDK remains compatible with the legacy
// DirectX SDK headers used by the engine.
#ifndef _WIN32_WINNT
