...
static_assert( sizeof( idDeclTable ) == 0x24, "retail idDeclTable ABI drift" );
#endif
...
=================
*/
bool idDeclTable::Validate( const char *text, int textLength, idStr &report ) const {
