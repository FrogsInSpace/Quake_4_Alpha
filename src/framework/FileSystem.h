...
public:
	...
	// The matching retail PDB predates the per-OS 1.4 SDK extension.
...
#if defined( _XENON ) || defined( Q4_RECON_ENGINE_PRIVATE )
	#ifndef Q4_RECON_ENGINE_PRIVATE
...
#ifndef Q4_RECON_ENGINE_PRIVATE
	// These interfaces were added after the executable represented by quake4.pdb.
	// new in 1.3
