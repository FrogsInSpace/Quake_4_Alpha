...
// Transitional mirror used until the private rvTools interface is restored.
...
#ifdef Q4_RECON_ENGINE_PRIVATE
	// Engine-only compatibility tail for Doom 3 seed call sites.  Retail
	// Quake 4 callers use the indexed localization methods above.
