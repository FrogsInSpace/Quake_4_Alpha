...
static_assert( sizeof( idCompressor ) == 0x4, "idCompressor ABI drift" );
static_assert( sizeof( idCompressor_None ) == 0xC, "idCompressor_None ABI drift" );
static_assert( sizeof( idCompressor_BitStream ) == 0x10038, "idCompressor_BitStream ABI drift" );
static_assert( sizeof( idCompressor_RunLength ) == 0x1003C, "idCompressor_RunLength ABI drift" );
static_assert( sizeof( idCompressor_RunLength_ZeroBased ) == 0x10038, "idCompressor_RunLength_ZeroBased ABI drift" );
static_assert( sizeof( idCompressor_Huffman ) == 0x1703C, "idCompressor_Huffman ABI drift" );
static_assert( sizeof( idCompressor_Arithmetic ) == 0x10850, "idCompressor_Arithmetic ABI drift" );
static_assert( sizeof( idCompressor_LZSS ) == 0x22102C, "idCompressor_LZSS ABI drift" );
static_assert( sizeof( idCompressor_LZSS_WordAligned ) == 0x22102C, "idCompressor_LZSS_WordAligned ABI drift" );
static_assert( sizeof( idCompressor_LZW ) == 0x2006C, "idCompressor_LZW ABI drift" );
#endif
