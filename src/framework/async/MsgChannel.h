...
#if !defined( Q4_RECON_SDK_MSGQUEUE )
class idMsgQueue {
public:
					idMsgQueue();
...
#if defined( _WIN32 ) && defined( Q4_RECON_SDK_MSGQUEUE )
static_assert( sizeof( idBitMsg ) == 0x24, "idBitMsg ABI drift" );
static_assert( sizeof( idMsgQueue ) == 0x4010, "idMsgQueue ABI drift" );
static_assert( sizeof( idMsgChannel ) == 0x100A0, "idMsgChannel ABI drift" );
#endif
