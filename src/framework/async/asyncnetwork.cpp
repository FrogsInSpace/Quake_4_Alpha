...
===============
*/
void idAsyncNetwork::BuildInvalidKeyMsg( idStr &msg, bool valid ) {
	if ( !valid ) {
		msg += common->GetLocalizedString( "#str_107194" );
	}
	msg += "\n";
	msg += common->GetLocalizedString( "#str_104304" );	
}
