...
static_assert( sizeof( idDeclPDA ) == 0x120, "retail idDeclPDA ABI drift" );
static_assert( sizeof( idDeclEmail ) == 0xC8, "retail idDeclEmail ABI drift" );
static_assert( sizeof( idDeclVideo ) == 0xA8, "retail idDeclVideo ABI drift" );
static_assert( sizeof( idDeclAudio ) == 0x88, "retail idDeclAudio ABI drift" );
#endif
...
size_t idDeclPDA::Size( void ) const {
	return sizeof( idDeclPDA ) + videos.Allocated() + audios.Allocated() + emails.Allocated() +
		pdaName.Allocated() + fullName.Allocated() + icon.Allocated() + id.Allocated() +
		post.Allocated() + title.Allocated() + security.Allocated();
}
...
size_t idDeclEmail::Size( void ) const {
	return sizeof( idDeclEmail ) + text.Allocated() + subject.Allocated() + date.Allocated() +
		to.Allocated() + from.Allocated() + image.Allocated();
}
...
size_t idDeclVideo::Size( void ) const {
	return sizeof( idDeclVideo ) + preview.Allocated() + video.Allocated() +
		videoName.Allocated() + info.Allocated() + audio.Allocated();
}
...
size_t idDeclAudio::Size( void ) const {
	return sizeof( idDeclAudio ) + audio.Allocated() + audioName.Allocated() +
		info.Allocated() + preview.Allocated();
}
